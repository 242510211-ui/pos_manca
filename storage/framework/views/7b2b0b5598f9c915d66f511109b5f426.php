...
<div class="container py-5 text-white">
    ...
    <div class="d-flex align-items-center justify-content-between mb-4">
        <a href="<?php echo e(route('dashboard')); ?>" class="btn-back-custom d-inline-flex align-items-center gap-2">
            ← Kembali
        </a>
            ...
            <div class="card card-custom h-100 text-center p-3">
                <div class="card-body d-flex flex-column align-items-center justify-content-center">
                    ...
                    <div class="mb-3 position-relative">
                        <img src="<?php echo e(asset('img/manca.jpeg')); ?>" 
                             alt="Foto Profil" 
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\pos_manca-main\resources\views/tentang_saya.blade.php ENDPATH**/ ?>