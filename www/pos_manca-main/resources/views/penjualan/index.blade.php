...
<div class="sales-wrapper">
    <div class="container-fluid px-4">
        ...
        <div class="d-flex align-items-center justify-content-between mb-4 flex-wrap gap-3">
            ...
            <a href="{{ route('penjualan.create') }}" class="btn btn-gunmetal-action d-inline-flex align-items-center gap-2">
        ...
        <div class="table-card-container">
            ...
            <div class="p-3 border-bottom border-secondary border-opacity-25 d-flex justify-content-between align-items-center flex-wrap gap-3">
                ...
                <form action="{{ route('penjualan.index') }}" method="GET" style="max-width: 350px; width: 100%;">
                ...
                <table class="table table-dark-custom align-middle">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td class="text-custom-main">{{ $sale->user->name }}</td>
                      <td class="price-total">Rp {{ number_format($sale->total_pembayaran) }}</td>
                      <td>
                        ...
                        @else
                            <span class="badge-pill-custom badge-transfer">{{ $sale->metode_pembayaran }}</span>
                        @endif
                      </td>
                      <td>
                        ...
                        @else
                            <span class="badge-pill-custom badge-status-pending"><i class="bi bi-clock-history"></i> {{ $sale->status }}</span>
                        @endif
                      </td>
                      <td class="text-center">
                        <div class="d-flex justify-content-center gap-1">
                            <a href="{{ route('penjualan.show', $sale) }}" class="btn btn-action-info btn-sm">
                                Detail
                            </a>

                            @can('view', $sale)
                            <a href="{{ route('penjualan.edit', $sale) }}" class="btn btn-action-edit btn-sm">
                                Edit
                            </a>
                            @endcan
                          ...
                          <button class="btn btn-action-delete btn-sm" 
                                    ...
                                    data-penjualan-name="Transaksi #{{ $sale->id }}">
                                Hapus
                            </button>
                            @endcan
                        </div>
