        ...
        <div class="row mt-4">
            ...
            <div class="col-md-6 mb-4">
                <div class="dashboard-card cash p-4">
                    ...
                    <h4>{{ $ringkasan['total_transaksi'] }} <span style="font-size: 1rem; font-weight: 500; color: #94a3b8;">Transaksi</span></h4>
                </div>
            </div>
        </div>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    <span class="badge badge-cyber-warning px-3 py-2 fw-bold">{{ $produk->stok }}</span>
                                </td>
                            </tr>
                            @empty
                            <tr>
                    ...
                    <table class="table custom-table-dark align-middle">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="fw-semibold text-white">{{ $produk->nama }}</td>
                                <td class="text-center">
                                    <span class="badge badge-cyber-danger px-3 py-2 fw-bold">{{ $produk->stok }}</span>
                                </td>
                            </tr>
                            @empty
                            <tr>
                    ...
                    <table class="table custom-table-dark align-middle">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td class="fw-semibold text-white">{{ $produk->nama }}</td>
                                <td class="text-center">
                                    <span class="badge bg-slate-700 text-light border border-slate-600 px-3 py-2">{{ $produk->stok }}</span>
                                </td>
                                <td class="text-center">
