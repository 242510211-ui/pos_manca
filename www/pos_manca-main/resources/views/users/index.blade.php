...
<div class="users-wrapper">
    <div class="container-fluid px-4">
        ...
        <div class="d-flex align-items-center justify-content-between mb-4 flex-wrap gap-3">
            ...
            <a href="{{ route('admin.users.create') }}" class="btn btn-gunmetal-action d-inline-flex align-items-center gap-2">
            ...
            <div class="col-md-4">
                <div class="stat-card-silver d-flex align-items-center gap-3">
                    ...
                    <div>
                        ...
                        <div class="stat-value">{{ $users->total() }} User</div>
                    </div>
                </div>
            </div>
            <div class="col-md-4">
        ...
        <div class="table-card-container">
            <div class="p-3 border-bottom border-secondary border-opacity-25 d-flex justify-content-between align-items-center flex-wrap gap-3">
                ...
                <form action="{{ route('admin.users') }}" method="GET" style="max-width: 360px; width: 100%;">
            ...
            <div class="table-responsive">
                <table class="table table-silver align-middle">
                  ...
                  <tbody>
                    ...
                    <tr>
                        <td class="text-center fw-bold" style="color: #94a3b8 !important;">{{ $users->firstItem() + $loop->index }}</td>
                        <td>
                        ...
                        <td class="user-email-text">{{ $user->email }}</td>
                        <td>
                            ...
                            @else
                                <span class="badge-pill-custom badge-default"><i class="bi bi-person-fill"></i> {{ optional($user->role)->name ?? 'User' }}</span>
                            @endif
                        </td>
                        <td class="text-center">
                            <div class="d-flex justify-content-center gap-2">
                                ...
                                {{-- Tombol Edit --}}
                                <a href="{{ route('admin.users.edit', $user) }}" class="btn btn-action-edit btn-sm">
