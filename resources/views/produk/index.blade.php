...
<div class="products-wrapper">
    <div class="container-fluid px-4">
        ...
        <div class="d-flex align-items-center justify-content-between mb-4 flex-wrap gap-3">
            ...
            <a href="{{ route('produk.create') }}" class="btn btn-gunmetal-action d-inline-flex align-items-center gap-2">
        ...
        <div class="table-card-container">
            ...
            <div class="p-3 border-bottom border-secondary border-opacity-25 d-flex justify-content-between align-items-center flex-wrap gap-3">
                ...
                <form action="{{ route('produk.index') }}" method="GET" style="max-width: 350px; width: 100%;">
                ...
                <table class="table table-dark-custom align-middle">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td class="text-custom-sub">{{ $product->user->name }}</td>
                      ...
                      <td>
                        <span class="product-name-text">{{ $product->nama }}</span>
                      </td>
                      <td class="price-buy">Rp {{ number_format($product->harga_beli) }}</td>
                      <td class="price-sell">Rp {{ number_format($product->harga_jual) }}</td>
                      <td class="text-center">
                        @if($product->stok > 20)
                            <span class="badge-pill-custom badge-stock-high">
                                <i class="bi bi-check-circle-fill"></i> {{ $product->stok }} unit
                            </span>
                        @elseif($product->stok > 0)
                            <span class="badge-pill-custom badge-stock-medium">
                                <i class="bi bi-exclamation-triangle-fill"></i> {{ $product->stok }} unit
                            </span>
                        @else
                      ...
                      <td class="text-center">
                        <div class="d-flex justify-content-center gap-1">
                            <a href="{{ route('produk.show', $product) }}" class="btn btn-action-info btn-sm">
                                Detail
                            </a>
                            
                            @can('update', $product)
                            <a href="{{ route('produk.edit', $product) }}" class="btn btn-action-edit btn-sm">
                                Edit
                            </a>
                            @endcan
