        ...
        <div class="card card-detail-silver">
            ...
            <div class="card-body p-4 p-md-5">
                ...
                <div class="info-item">
                    ...
                    <span class="info-value price-tag-buy">Rp {{ number_format($produk->harga_beli, 0, ',', '.') }}</span>
                </div>

                <div class="info-item">
                    <span class="info-label"><i class="bi bi-cash-stack text-info"></i> Harga Jual</span>
                    <span class="info-value price-tag-sell">Rp {{ number_format($produk->harga_jual, 0, ',', '.') }}</span>
                </div>
                ...
                <div class="info-item mb-4">
                    ...
                    <span class="info-value">{{ optional($produk->user)->name ?? 'Sistem' }}</span>
                </div>

                <!-- Tombol Navigasi -->
                <div class="text-center mt-4">
                    <a href="{{ route('produk.index') }}" class="btn-gunmetal-back">
